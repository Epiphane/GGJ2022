...
define(["require", "exports", "./juicy.sound", "./juicy.point", "./juicy.point"], function (require, exports, juicy_sound_1, juicy_point_1, juicy_point_2) {
    ...
    class Game {
        ...
        getCanvasCoords(evt) {
            ...
            return new juicy_point_1.Point(mx, my).add(this.state.cameraOffset);
        }
        resize() {
            if (!this.canvas) {
                throw Error('Game was not properly initialized - canvas is unavailable');
        ...
        render() {
            ...
            if (!this._state.stopClear) {
                context.fillStyle = (_a = this._state.clearColor) !== null && _a !== void 0 ? _a : this.clearColor;
