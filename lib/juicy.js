...
define(["require", "exports", "./juicy.sound", "./juicy.point", "./juicy.point"], function (require, exports, juicy_sound_1, juicy_point_1, juicy_point_2) {
    ...
    exports.Sound = exports.rand = exports.BehaviorComponent = exports.TextComponent = exports.BoxComponent = exports.ImageComponent = exports.Component = exports.Entity = exports.State = exports.Game = exports.SetCanvasSize = void 0;
    /* -------------------- Animation frames ----------------- */
    ...
    class Game {
        ...
        getCanvasCoords(evt) {
            ...
            return new juicy_point_1.Point(mx, my).mult(this.size);
        }
        resize() {
            if (!this.canvas) {
                throw Error('Game was not properly initialized - canvas is unavailable');
        ...
        keyDown(key) {
            ...
            if (typeof (key) === 'string') {
                return (_a = this.keyState[key]) !== null && _a !== void 0 ? _a : false;
            }
            else {
